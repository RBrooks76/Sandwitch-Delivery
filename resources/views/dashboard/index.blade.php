                    ...
                    <div class="d-flex">
                        <div class="text-white">
                            ...
                            <div class="progress h-2" style="margin-top:20px">
                                <div class="progress-bar" role="progressbar" style="width: {{ ($Restaurants / 300) * 100 }}%!important;background-color: #24dcc2"></div>
                            </div>
                ...
                <div class="card-body card-taps">
                    ...
                    <div class="d-flex">
                        <div class="text-white">
                            ...
                            <div class="progress h-2" style="margin-top:20px">
                                <div class="progress-bar" role="progressbar" style="width:{{ ($pro / 20000) * 100 }}%!important;background-color: #24dcc2"></div>
                            </div>
                ...
                <div class="card-body card-taps">
                    ...
                    <div class="d-flex">
                        <div class="text-white">
                            ...
                            <div class="progress h-2" style="margin-top:20px">
                                <div class="progress-bar w-50" role="progressbar" style="width:{{ ($users / 100000) * 100 }}%!important;background-color: #24dcc2"></div>
                            </div>
                    ...
                    <div class="d-flex">
                        <div class="text-white">
                            ...
                            <div class="progress  " style="margin-top:20px">
                                <div class="progress-bar" role="progressbar" style="width:{{ ($orrder / 1000000) * 100 }}%!important;background-color: #24dcc2"></div>
                            </div>
