...
@section('create_btn'){{ URL('dashboard/coupons/add_edit') }}@endsection
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.btn_deleted').on("click", function() {
                var id = $('#iddel').val();
                $.ajax({
                    url: "{{ URL('dashboard/coupons/deleted') }}",
                    method: "get",
                    data: {
                        "id": id,
                    },
        ...
        var Render_Data = function(type) {
            datatabe = $('#data_Table').DataTable({
                ...
                "ajax": {
                    "url": "{{ URL('dashboard/coupons/get_data') }}",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
                        _token: "{{ csrf_token() }}",
        ...
        $(document).on('click', '.btn_confirm_email_current', function() {
                ...
                $.ajax({
                    url: "{{ URL('dashboard/coupons/confirm_email') }}",
                    method: "get",
                    data: {
                        "id": id,
                    },
