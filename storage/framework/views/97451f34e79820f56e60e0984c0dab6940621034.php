...
<?php $__env->startSection('create_btn'); ?><?php echo e(route('dashboard_slider.add_edit')); ?><?php $__env->stopSection(); ?>
    ...
    <div class="row row-cards row-deck">
        ...
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-4 data_Table" id="data_Table<?php echo e($r->id); ?>">
                <div class="card">
                    <img class="card-img-topbr-tr-0 br-tl-0" src="<?php echo e($r->img1()); ?>" alt="<?php echo e($r->name); ?>">
                    <div class="card-header">
                        <h5 class="card-title"><?php echo e($r->name); ?></h5>
                    </div>
                    <div class="card-body">
                        <a class="btn btn-sm btn-primary" href="<?php echo e(route('dashboard_slider.add_edit',['id' => $r->id])); ?>"><i class="fa fa-edit"></i> Edit</a>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.btn_featured', function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('dashboard_slider.featured')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
            ...
            $('.btn_deleted').on("click", function () {
                var id = $('#iddel').val();
                $.ajax({
                    url: "<?php echo e(route('dashboard_slider.deleted')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
            ...
            $(document).on('click', '.ajax_delete_all', function () {
                $.ajax({
                    url: "<?php echo e(route('dashboard_slider.deleted_all')); ?>",
                    method: "get",
                    data: {
                        "array": array,
                    },
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/slider/index.blade.php ENDPATH**/ ?>