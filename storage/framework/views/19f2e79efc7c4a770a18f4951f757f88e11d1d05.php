...
<?php $__env->startSection('create_btn'); ?><?php echo e(route('dashboard_restaurant.add_edit')); ?><?php $__env->stopSection(); ?>
        ...
        $(document).ready(function () {
            ...
            //   console.log(e.target.value, $(this).data('id'));
               ...
               var priority = e.target.value;
                $.ajax({
                    url: "<?php echo e(route('dashboard_restaurant.priority')); ?>",
                    method: "get",
                    data: {
                        id,
                        priority,
            ...
            $(document).on('click', '.btn_featured', function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('dashboard_restaurant.featured')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
            ...
            $('.btn_deleted').on("click", function () {
                var id = $('#iddel').val();
                $.ajax({
                    url: "<?php echo e(route('dashboard_restaurant.deleted')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
            ...
            $(document).on('click', '.ajax_delete_all', function () {
                $.ajax({
                    url: "<?php echo e(route('dashboard_restaurant.deleted_all')); ?>",
                    method: "get",
                    data: {
                        "array": array,
                    },
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/restaurant/index.blade.php ENDPATH**/ ?>