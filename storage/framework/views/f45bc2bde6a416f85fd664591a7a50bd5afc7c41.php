...
<?php $__env->startSection('create_btn'); ?><?php echo e(URL('dashboard/driver/add_edit')); ?><?php $__env->stopSection(); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.ajax_delete_all', function() {
                $.ajax({
                    url: "<?php echo e(route('dashboard_city.deleted_all')); ?>",
                    method: "get",
                    data: {
                        "array": array,
                    },
            ...
            $('.btn_deleted').on("click", function() {
                var id = $('#iddel').val();
                $.ajax({
                    url: "<?php echo e(URL('dashboard/driver/deleted')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
            ...
            $(document).on('change', '.input-priority', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('dashboard_city.priority')); ?>",
                    method: "get",
                    data: {
                        id,
                        priority,
        ...
        var Render_Data = function(type) {
            datatabe = $('#data_Table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(URL('dashboard/driver/get_rating_data')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
        ...
        $(document).on('click', '.btn_confirm_email_current', function() {
                ...
                $.ajax({
                    url: "<?php echo e(URL('dashboard/driver/confirm_email')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
                    ...
                    success: function(result) {
                        if (result.error != null) {
                            toastr.error(result.error, "Driver");
                        } else {
                            toastr.success(result.success, "Driver");
                        }
                        $('#data_Table').DataTable().ajax.reload();
                    }
                });
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/Drivers/rating.blade.php ENDPATH**/ ?>