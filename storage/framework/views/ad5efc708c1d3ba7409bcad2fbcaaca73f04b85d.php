...
<aside class="app-sidebar">
    ...
    <ul class="side-menu">
        ...
        <?php if(Auth::user()->role == '1'): ?>
            ...
            <li>
                <a class="side-menu__item" href="<?php echo e(URL('dashboard/driver')); ?>">
                    <i class="side-menu__icon side-menu__icon fe fe-mail"></i>
            ...
            <li>
                <a class="side-menu__item" href="<?php echo e(URL('dashboard/driver/rating')); ?>">
                    <i class="side-menu__icon side-menu__icon fe fe-mail"></i>
            ...
            <li>
                <a class="side-menu__item" href="<?php echo e(URL('dashboard/driver/complaint')); ?>">
                    <i class="side-menu__icon side-menu__icon fe fe-mail"></i>
...
<?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/layouts/sidebar.blade.php ENDPATH**/ ?>