    ...
    <div class="container-fluid">
        <div class="d-flex">
            ...
            <a class="header-brand" href="index.html">
                <img src="<?php echo e($path); ?>login_style/assets/img/Sandwich Map-1.png" class="header-brand-img desktop-logo" alt="logo">
                <img src="<?php echo e($path); ?>login_style/assets/img/Sandwich Map-1.png" class="header-brand-img desktop-logo mobile-light" alt="logo">
            </a>
            <div class="d-flex order-lg-2 ml-auto header-right-icons">
                ...
                <div class="dropdown profile-1">
                    <a href="#" data-toggle="dropdown" class="nav-link pr-2 leading-none d-flex">
										<span>
											<img src="<?php echo e($path.$user->avatar); ?>" alt="profile-user" class="avatar  profile-user brround cover-image">
										</span>
                    </a>
...
</div><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/layouts/mobile.blade.php ENDPATH**/ ?>