    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var url = $(location).attr('href'),
                ...
                newlp = last_part.split("?");
                console.log(newlp[0]);
                
            var name_form = $('.ajaxForm').data('name');

            if (isNaN(newlp[0]) == false) {
                if (last_part != null) {
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/users/add_edit.blade.php ENDPATH**/ ?>