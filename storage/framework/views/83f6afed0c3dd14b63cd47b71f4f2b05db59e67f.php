    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var datatable = $('#data_Table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('dashboard_ownrestaurant.get_data')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
            ...
            $(document).on('click', '.ajax_delete_all', function () {
                $.ajax({
                    url: "<?php echo e(route('dashboard_ownrestaurant.deleted_all')); ?>",
                    method: "get",
                    data: {
                        "array": array,
                    },
            ...
            $('.btn_deleted').on("click", function () {
                var id = $('#iddel').val();
                $.ajax({
                    url: "<?php echo e(route('dashboard_ownrestaurant.deleted')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/userrestaurant/index.blade.php ENDPATH**/ ?>