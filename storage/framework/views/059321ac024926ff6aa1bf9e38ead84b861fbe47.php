...
<?php $__env->startSection('create_btn'); ?><?php echo e(route('dashboard_sub_category.index')); ?><?php $__env->stopSection(); ?>
    ...
    <div class="card mb-4 wow fadeIn">
        <div class="card-body">
            ...
            <form class="ajaxForm sub_category" enctype="multipart/form-data" data-name="sub_category"
                  action="<?php echo e(route('dashboard_sub_category.post_data')); ?>" method="post">
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript">
        ...
        var Render_Data = function (id) {
            $.ajax({
                url: "<?php echo e(route('dashboard_sub_category.get_data_by_id')); ?>",
                method: "get",
                data: {
                    "id": id,
                },
                ...
                success: function (result) {
                    if (result.success != null) {
                        ...
                        window.location.href = "<?php echo e(route('dashboard_sub_category.index')); ?>";
                    }
                }
            });
        };
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/sub_category/add_edit.blade.php ENDPATH**/ ?>