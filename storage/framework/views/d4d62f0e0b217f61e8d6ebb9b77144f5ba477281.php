...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card mb-4 wow fadeIn">
        <div class="card-body">
            ...
            <form class="ajaxForm city" enctype="multipart/form-data" data-name="city"
                  action="<?php echo e(route('dashboard_city.post_data')); ?>" method="post">
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript">
        ...
        var Render_Data = function (id) {
            $.ajax({
                url: "<?php echo e(route('dashboard_city.get_data_by_id')); ?>",
                method: "get",
                data: {
                    "id": id,
                },
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/city/add_edit.blade.php ENDPATH**/ ?>