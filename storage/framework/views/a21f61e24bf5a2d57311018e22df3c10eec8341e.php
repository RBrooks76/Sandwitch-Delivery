    ...
    <div class="d-flex header-right-icons header-search-icon">
        ...
        <div class="dropdown profile-1">
            ...
            <a href="#" data-toggle="dropdown" class="nav-link pr-2 leading-none">
    			<span>
    				<img src="<?php echo e($path.$user->avatar); ?>" alt="<?php echo e($user->name); ?>" class="avatar  profile-user brround cover-image" width="35">
    			</span>
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                <div class="drop-heading">
                    <div class="text-center">
                        <h5 class="text-dark mb-0"><?php echo e($user->name); ?></h5>
                        <small class="text-muted"><?php echo e($user->email); ?></small>
                    </div>
                </div>
                <div class="dropdown-divider m-0"></div>
                <a href="<?php echo e(route('dashboard_users.index')); ?>" class="dropdown-item">
...
<!-- PAGE-HEADER END -->
<?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/layouts/breadcrumb.blade.php ENDPATH**/ ?>