...
<?php $__env->startSection('create_btn'); ?><?php echo e(route('dashboard_city.add_edit')); ?><?php $__env->stopSection(); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.btn_deleted').on("click", function() {
                var id = $('#iddel').val();
                $.ajax({
                    url: "<?php echo e(route('dashboard_city.deleted')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
            ...
            $(document).on('click', '.btn_confirm_email_current', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('dashboard_city.confirm_email')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
                    ...
                    success: function(result) {
                        if (result.error != null) {
                            toastr.error(result.error, "City");
                        } else {
                            toastr.success(result.success, "City");
                        }
                        $('#data_Table').DataTable().ajax.reload();
                    }
                });
        ...
        var Render_Data = function(type) {
            datatabe = $('#data_Table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('dashboard_city.get_data')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/city/index.blade.php ENDPATH**/ ?>