...
<?php $__env->startSection('create_btn'); ?><?php echo e(route('dashboard_products.index', ['id' => null, 'restaurant_id' => app('request')->input('restaurant_id')])); ?><?php $__env->stopSection(); ?>
    <?php $__env->startSection('create_btn_btn'); ?> Close <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

    <form class="ajaxForm users" enctype="multipart/form-data" data-name="users" action="<?php echo e(route('dashboard_products.post_data')); ?>" method="post">
        <?php echo e(csrf_field()); ?>


        <input id="id" name="id" class="cls" type="hidden">
        <input id="restaurant_id" name="restaurant_id" class="cls" value="<?php echo e(app('request')->input('restaurant_id')); ?>" type="hidden">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="<?php echo e(route('dashboard_sub_category.add_edit')); ?>" target="_blank" class="btn btn-primary" style="transform: translateY(35px);">
...
<?php $__env->startSection('js'); ?>
    <script type="text/javascript">
        ...
        var Render_Data = function(id) {
            $.ajax({
                url: "<?php echo e(route('dashboard_products.get_data_by_id')); ?>",
                method: "get",
                data: {
                    "id": id,
                },
                ...
                success: function(result) {
                    if (result.success != null) {
                        ...
                        window.location.href = "<?php echo e(route('dashboard_products.index')); ?>";
                    }
                }
            });
        };
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/products/add_edit.blade.php ENDPATH**/ ?>