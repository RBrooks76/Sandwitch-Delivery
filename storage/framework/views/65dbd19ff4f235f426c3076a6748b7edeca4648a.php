                    ...
                    <div class="d-flex">
                        <div class="text-white">
                            ...
                            <div class="progress h-2" style="margin-top:20px">
                                <div class="progress-bar" role="progressbar" style="width: <?php echo e(($Restaurants / 300) * 100); ?>%!important;background-color: #24dcc2"></div>
                            </div>
                            <span class="d-inline-block" style="color: #FFF">Target: 300</span>
                        </div>
                ...
                <div class="card-body card-taps">
                    ...
                    <div class="d-flex">
                        <div class="text-white">
                            ...
                            <div class="progress h-2" style="margin-top:20px">
                                <div class="progress-bar" role="progressbar" style="width:<?php echo e(($pro / 20000) * 100); ?>%!important;background-color: #24dcc2"></div>
                            </div>
                            <span class="d-inline-block" style="color: #FFF">Target: 20000</span>
                        </div>
                ...
                <div class="card-body card-taps">
                    ...
                    <div class="d-flex">
                        <div class="text-white">
                            ...
                            <div class="progress h-2" style="margin-top:20px">
                                <div class="progress-bar w-50" role="progressbar" style="width:<?php echo e(($users / 100000) * 100); ?>%!important;background-color: #24dcc2"></div>
                            </div>
                    ...
                    <div class="d-flex">
                        <div class="text-white">
                            ...
                            <div class="progress  " style="margin-top:20px">
                                <div class="progress-bar" role="progressbar" style="width:<?php echo e(($orrder / 1000000) * 100); ?>%!important;background-color: #24dcc2"></div>
                            </div>
                            <span class="d-inline-block" style="color: #FFF">Target: 1000000</span>
                        </div>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/index.blade.php ENDPATH**/ ?>