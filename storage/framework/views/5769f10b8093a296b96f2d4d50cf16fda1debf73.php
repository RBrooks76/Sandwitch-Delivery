    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '.btn_eye', function () {
                var id = $(this).data("id");
                $.ajax({
                    url: "<?php echo e(route('dashboard_contact_us.details')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
            ...
            $('.btn_deleted').on("click", function () {
                var id = $('#iddel').val();
                $.ajax({
                    url: "<?php echo e(route('dashboard_contact_us.deleted')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
        ...
        var Render_Data = function () {
            datatabe = $('#data_Table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('dashboard_contact_us.get_data')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/contact_us/index.blade.php ENDPATH**/ ?>