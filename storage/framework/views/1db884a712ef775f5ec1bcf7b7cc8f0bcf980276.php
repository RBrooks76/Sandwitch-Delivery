...
<?php $__env->startSection('create_btn'); ?><?php echo e(route('dashboard_sub_category.add_edit')); ?><?php $__env->stopSection(); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.ajax_delete_all', function() {
                $.ajax({
                    url: "<?php echo e(route('dashboard_sub_category.deleted_all')); ?>",
                    method: "get",
                    data: {
                        "array": array,
                    },
            ...
            $('.btn_deleted').on("click", function() {
                var id = $('#iddel').val();
                $.ajax({
                    url: "<?php echo e(route('dashboard_sub_category.deleted')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
            ...
            $(document).on('click', '.btn_confirm_email_current', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('dashboard_sub_category.confirm_email')); ?>",
                    method: "get",
                    data: {
                        "id": id,
                    },
        ...
        var Render_Data = function(type) {
            datatabe = $('#data_Table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('dashboard_sub_category.get_data')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sandwichmap/public_html/resources/views/dashboard/sub_category/index.blade.php ENDPATH**/ ?>